              ...
              <div className="grid lg:grid-cols-12 gap-12 items-start">
                  ...
                  <div className="relative aspect-square bg-white rounded-[48px] border-2 border-slate-100 p-16 shadow-2xl mx-auto w-full max-w-[600px] group/chart">
                    ...
                    <div className="absolute top-12 right-12 text-center z-10">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="text-[16px] font-black text-emerald-900 bg-white/95 px-5 py-2 rounded-2xl border-2 border-emerald-100 shadow-xl">I. 自立發展</div>
                      </div>
                    </div>
                    <div className="absolute top-12 left-12 text-center z-10">
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 bg-blue-100 rounded-2xl flex items-center justify-center border-2 border-blue-200 shadow-sm">
                          <Home className="w-6 h-6 text-blue-600" />
                        </div>
                        <div className="text-[16px] font-black text-blue-900 bg-white/95 px-5 py-2 rounded-2xl border-2 border-blue-100 shadow-xl">II. 穩定生活</div>
                      </div>
                    </div>
                    <div className="absolute bottom-12 right-12 text-center z-10">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="text-[16px] font-black text-amber-900 bg-white/95 px-5 py-2 rounded-2xl border-2 border-amber-100 shadow-xl">III. 潛力待援</div>
                      </div>
                    </div>
                    <div className="absolute bottom-12 left-12 text-center z-10">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="text-[16px] font-black text-rose-900 bg-white/95 px-5 py-2 rounded-2xl border-2 border-rose-100 shadow-xl">IV. 高危支持</div>
                      </div>
                    </div>
                ...
                <div className="lg:col-span-5 space-y-8">
                  <div className="p-8 bg-brand-50 rounded-[40px] border-2 border-brand-100 relative overflow-hidden shadow-sm">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className={`w-5 h-5 rounded-full shadow-md ring-4 ring-white ${
                        report.quadrant.id === 'I' ? 'bg-emerald-500' :
                        report.quadrant.id === 'II' ? 'bg-blue-500' :
                        report.quadrant.id === 'III' ? 'bg-amber-500' : 'bg-rose-500'
                      }`} />
                  ...
                  <div className="space-y-4">
                    ...
                    {[
                      { id: 'I', name: '自立發展型', color: 'bg-emerald-500', desc: '穩定度與發展度皆高，具備重返社會與職場的極佳潛力。', action: '媒合進階職訓、創業支持' },
                      { id: 'II', name: '穩定生活型', color: 'bg-blue-500', desc: '生活基盤穩固但發展意願或能力受限，重點在於維持現狀。', action: '維持長照、社區參與' },
                      { id: 'III', name: '潛力待援型', color: 'bg-amber-500', desc: '具備發展潛力 but 照顧基盤不穩，需優先導入資源穩固生活。', action: '強化家庭支持、導入居服' },
                      { id: 'IV', name: '高危支持型', color: 'bg-rose-500', desc: '雙重弱勢，需高度社會福利支持與長期照顧介入。', action: '緊急安置、高額補助媒合' }
                    ].map(q => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 text-slate-800">
                  ...
                  <h3 className="text-xl font-bold">對接清單 (Top 3-5 優先行動)</h3>
                </div>
                <div className="space-y-4">
